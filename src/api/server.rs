use crate::api::handlers::{
	deregister_upstream_handler, drain_upstream_handler, get_upstream_status_handler,
	health_check_handler, list_upstreams_handler, register_upstream_handler,
};
...
pub fn create_router(state: DynamicLBState) -> Router {
	Router::new()
		...
		.route("/upstreams/drain", post(drain_upstream_handler))
		.route("/upstreams/status", get(get_upstream_status_handler))
