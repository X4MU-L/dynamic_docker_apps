...
use health::draining::DrainingService;
use pingora::prelude::*;
...
fn main() {
	...
	let drain_svc = DrainingService::new(state.clone(), Duration::from_secs(1));
	my_server.add_service(background_service("draining_service", drain_svc));
